  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="chengeDefault(address, addressInfo)">
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b
            ><i>{{ orderInfo.totalNum }}.00</i>件商品，总商品金额</b
          >
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        consigneeTel: this.userDefaultAddress.consigneeTel, //手机号
        deliveryAddress: this.userDefaultAddress.deliveryAddress, //地址
